              ...
              <form onSubmit={handleSubmit}>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="number" className="input input-bordered mt-2 input-primary w-full max-w" placeholder="Masukkan Jumlah Murid" value={jumlah}  onChange={e => setjumlah(e.target.value)} />
                                </div>
                            {/* <div class="form-group">
