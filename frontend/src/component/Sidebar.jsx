      ...
      <div>
        ...
        <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
          <ul class="flex flex-col py-4 space-y-1">
            ...
            <li>
                <div className="flex flex-col items-center mr-5">
                  <div className="text-center items-center"> 
                    <img src={avatar} alt="Profile Picture" className="rounded-full mb-5 mt-4 hidden  md:block" width="120" height="120"/>
            ...
            <li>
              <div class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                <span class="inline-flex justify-center items-center ml-4">
            ...
            {user && user.role === "admin" && (
            <li>
              <a href="../admin/kelas" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                <span class="inline-flex justify-center items-center ml-4">
                <FontAwesomeIcon icon={faCalendarCheck} className="w-5 h-5" />
                </span>
                <span class="ml-4 text-sm tracking-wide truncate">Rekap</span>
              </a>
            </li>
            )}

            <li>
              <a href="/logout" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                <span class="inline-flex justify-center items-center ml-4">
                <FontAwesomeIcon icon={faSignOutAlt} className="w-5 h-5" />
                </span>
                <button onClick={logout} className="ml-4 button is-white">
                Logout
              </button>
              </a>
            </li>
      ...
      <ul class="flex flex-col py-4 space-y-1">
        ...
        <li>
          <a href="../siswa/profile" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
            ...
            <span class="ml-4 text-sm tracking-wide truncate">Profile</span>
          </a>
        </li>
        <li>
          <a href="../siswa/absen" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
            ...
            <span class="ml-4 text-sm tracking-wide truncate">Absen</span>
          </a>
        </li>
        <li>
          <a href="/logout" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
            ...
            <span class="ml-4 text-sm tracking-wide truncate"> Logout</span>
          </a>
        </li>
      </ul>
      <p class="mb-14 px-5 py-3 hidden md:block text-center text-xs">Copyright @2023</p>
...
<div>
        <div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
        <div class="flex items-center justify-start md:justify-center w-full md:w-64 h-14 bg-purple-900 dark:bg-gray-900 border-none">
        <b><p class="text-1xl ml-1">GURU</p></b>
        </div>
  <div class="flex justify-between items-center flex-grow h-14 bg-purple-900 dark:bg-gray-900 header-right">
  <nav class = "flex px-5 py-3 text-gray-700  rounded-lg bg-opacity-50 bg-gray-50 dark:bg-[#1E293B] " aria-label="Breadcrumb">
            <ol class = "inline-flex items-center space-x-1 md:space-x-3">
    ...
    <div className="dropdown dropdown-end">
      ...
      <div tabIndex={0} className="mt-3 card card-compact dropdown-content w-52 bg-base-100 shadow">
        <div className="card-body">
          <span className="font-bold text-lg">{date.toLocaleDateString()}</span>
          <span className="text-info">Lihat rekap siswa</span>
          <div className="card-actions">
            <Link to="../admin/kelas">
            <button className="btn btn-primary btn-block">Lihat</button>
            </Link>
          </div>
        </div>
      </div>
      ...
      <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
        <ul class="flex flex-col py-4 space-y-1">
          ...
          <li>
            <a href="../guru/rekap" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
              <span class="inline-flex justify-center items-center ml-4">
              <FontAwesomeIcon icon={faCalendarCheck} className="w-5 h-5" />
              </span>
              <span class="ml-2 text-sm tracking-wide truncate">Rekap</span>
            </a>
          </li>
          <li>
          <a href="/logout" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
