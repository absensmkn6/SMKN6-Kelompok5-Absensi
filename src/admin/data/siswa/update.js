                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <option disabled selected>Pilih Kelas</option>
                                    ...
                                    <option onChange={e => setkelas(e.target.value)}>XI</option>
                                    <option onChange={e => setkelas(e.target.value)}>XII</option>
                                </select> */}
                            </div>
                            <div class="form-group">
                            ...
                            {/* <div class="form-group">
                                ...
                                <input type="text" className="input input-bordered mt-2 input-primary w-full max-w" placeholder="Masukkan Tanggal Lahir" onChange={e => setjurusan(e.target.value)}/>
                                <select className="select select-primary w-full max-w mt-2" onChange={e => setjurusan(e.target.value)}>
                                <option disabled selected>Pilih Jurusan</option>
                                    <option onChange={e => setjurusan(e.target.value)}>RPL</option>
                                    <option onChange={e => setjurusan(e.target.value)}>MM</option>
                                </select>
                            </div> */}
                            
                            {/* <div class="form-group">
                                <label>Jenis Kelamin</label><br></br>
                                <input type="text" className="input input-bordered mt-2 input-primary w-full max-w" placeholder="Masukkan Tanggal Lahir" onChange={e => setgender(e.target.value)}/>
                                    <select className="select select-primary w-full max-w mt-2" onChange={e => setgender(e.target.value)}>
                                    <option disabled selected>Pilih Jenis Kelamin</option>
                                        <option onChange={e => setgender(e.target.value)}>Laki-Laki</option>
                                        <option onChange={e => setgender(e.target.value)}>Perempuan</option>
                                    </select>
