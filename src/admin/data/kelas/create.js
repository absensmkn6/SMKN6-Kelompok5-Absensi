...
function handleSubmit(event) {
    ...
    axios.post('http://localhost:8081/createk', {nama_kelas, jurusan, jumlah}).then(res => {
        console.log(res);
              ...
              <form onSubmit={handleSubmit}>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" className="input input-bordered mt-2 input-primary w-full max-w" placeholder="Masukkan Jurusan" onChange={e => setjurusan(e.target.value)} name="jurusan" />
                            </div>
                            <div class="form-group">
