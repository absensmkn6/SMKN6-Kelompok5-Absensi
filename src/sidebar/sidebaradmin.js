...
const SidebarAdmin = () => {
  ...
  useEffect(() => {
    ...
    return(
        ...
        <b><p class="text-1xl ml-1">ADMIN</p></b>
        </div>
    ...
    <div className="dropdown dropdown-end">
      ...
      <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
        <ul class="flex flex-col py-4 space-y-1">
          ...
          <li>
            <div class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
              ...
              <div className="dropdown dropdown-arrow">
                <label tabIndex={0} className="ml-2">Data<label></label></label>
                   <ul tabIndex={0} className="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
                        <li><Link to="/admin/datas">Data Siswa</Link></li>
          ...
          <li>
            <a href="../admin/logout" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
              <span class="inline-flex justify-center items-center ml-4">
