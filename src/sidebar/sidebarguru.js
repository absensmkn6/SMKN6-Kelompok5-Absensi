...
import avatar from '../images/avaguru.png';
  ...
  <nav class = "flex px-5 py-3 text-gray-700  rounded-lg bg-opacity-50 bg-gray-50 dark:bg-[#1E293B] " aria-label="Breadcrumb">
            <ol class = "inline-flex items-center space-x-1 md:space-x-3">
                <li class = "inline-flex items-center">
                    <a href="../guru/dashboard" class = "inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
      ...
      <div class="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
        <ul class="flex flex-col py-4 space-y-1">
          ...
          <li>
              <div className="flex flex-col items-center mr-5">
                <div className="text-center items-center">
                  ...
                  <p className="text-lg font-semibold hidden md:block">Marsha Lenathea</p>
          ...
          <li class="px-5 hidden md:block">
            ...
            <a href="../guru/dashboard" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6 active">
          ...
          <li>
            <a href="../guru/profile" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
              <span class="inline-flex justify-center items-center ml-4">
