        ...
        <div class="md:flex no-wrap md:-mx-2 ">
            ...
            <div class="w-full md:w-3/12 md:mx-2">
                ...
                <div class="bg-violet-700 dark:bg-gray-800 rounded-md p-3 border-t-4 border-purple-900 dark:border-gray-400">
                    ...
                    <h1 class="text-white font-bold text-xl leading-8 my-1">Nama Guru</h1>
                    <img src={guru1} alt="Profile Picture" className="rounded-full mb-2 mt-4 hidden md:block mx-auto block" width="120" height="120"/>
                    ...
                    <div class="text-gray-400">
                        <div class="grid md:grid-cols-2 text-sm">
                            <div class="grid grid-cols-2">
                                ...
                                <div class="px-4 py-2">Nama Panggilan Guru</div>
                            </div>
                            <div class="grid grid-cols-2">
                                <div class="px-4 py-2 font-semibold">Nama Lengkap:</div>
                                <div class="px-4 py-2">Nama Lengkap Guru</div>
                            </div>
                            <div class="grid grid-cols-2">
                                <div class="px-4 py-2 font-semibold">NUPTK:</div>
                                <div class="px-4 py-2">1097977</div>
                            </div>
                            <div class="grid grid-cols-2">
                                <div class="px-4 py-2 font-semibold">Mata Pelajaran:</div>
                                <div class="px-4 py-2">PPKN</div>
                            </div>
                            <div class="grid grid-cols-2">
                        ...
                        <div class="bg-violet-700 dark:bg-gray-800 p-3 hover:shadow border-white rounded-md justify-center">
